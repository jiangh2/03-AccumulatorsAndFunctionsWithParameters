...
def run_test_sum_of_digits():
    ...
    expected = 27
    answer = sum_of_digits(88812)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 23
    answer = sum_of_digits(24890)
...
def run_test_digits_in_power():
    ...
    expected = 4
    answer = digits_in_power(4, 1)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    expected = 28
    answer = digits_in_power(46, 3)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 53
    answer = digits_in_power(98, 5)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_fancy_sums_of_digits():
    ...
    # ------------------------------------------------------------------
print(sum_of_digits(4**1000))
print(sum_of_digits(4**999))
print(sum_of_digits(2704**2611))
